...
router.get('/email-test', async (req, res) => {
    try {
        const isConnected = await (0, email_1.verifySMTPConnection)();
        if (!isConnected) {
...
router.post('/forgot-password', async (req, res) => {
    try {
        ...
        const emailResult = await (0, email_1.sendPasswordResetEmail)(email, user.username, resetToken);
...
router.post('/reset-password', async (req, res) => {
    try {
        ...
        await (0, email_1.sendPasswordResetConfirmation)(email, user.username);
        res.json({
            success: true,
