...
router.get('/stats', roleMiddleware(['SUPERADMIN', 'ADMIN']), async (req: Request, res: Response) => {
  try {
...
router.get('/actions', roleMiddleware(['SUPERADMIN', 'ADMIN']), async (req: Request, res: Response) => {
  try {
...
router.get('/:id', roleMiddleware(['SUPERADMIN', 'ADMIN']), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.post('/clear', roleMiddleware(['SUPERADMIN']), async (req: Request, res: Response) => {
  try {
