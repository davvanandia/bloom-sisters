...
router.get('/payment/sync/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.get('/user/my-orders', async (req: Request, res: Response) => {
  try {
    const user = (req as any).user;
    const { 
      page = '1', 
...
router.put('/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.patch('/:id/status', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const user = (req as any).user;
...
router.get('/status/counts', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
    ...
    counts.forEach(item => {
      const status = item.status as keyof typeof result;
      if (status in result) {
...
router.get('/stats/summary', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
...
router.get('/recent/activity', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: Request, res: Response) => {
  try {
