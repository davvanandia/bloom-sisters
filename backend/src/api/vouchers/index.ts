...
router.get('/', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
...
router.post('/', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
...
router.get('/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
    const { id } = req.params;
...
router.put('/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
    const { id } = req.params;
...
router.put('/:id/toggle', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
    const { id } = req.params;
...
router.delete('/:id', roleMiddleware(['ADMIN', 'SUPERADMIN']), async (req: any, res) => {
  try {
    const { id } = req.params;
